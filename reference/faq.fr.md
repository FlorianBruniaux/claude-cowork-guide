...
**R :** Au-delà des compétences officielles Anthropic sur `github.com/anthropics/skills`, des compétences créées par la communauté sont disponibles sur `claudemarketplaces.com`, `skills.sh`, `remoteopenclaw.com/skills/claude` et `skillhub.club`. Installez n'importe quelle compétence depuis l'onglet Personnaliser en cherchant par nom ou en collant l'URL.
