...
description: "Sync Claude Cowork releases from local CHANGELOG to guide YAML + landing TypeScript"
argument-hint: "[--since <version>] [--dry-run]"
---

# Update Claude Cowork Releases

Parse the Cowork guide CHANGELOG and sync both:
1. **Guide YAML**: `/Users/florianbruniaux/Sites/perso/claude-cowork-guide/machine-readable/claude-cowork-releases.yaml`
2. **Landing TS**: `/Users/florianbruniaux/Sites/perso/claude-cowork-guide-landing/src/data/releases.ts`

Unlike Claude Code, there is no npm package or external CHANGELOG. The source of truth is the local CHANGELOG.md in the guide repo.
...
Read `/Users/florianbruniaux/Sites/perso/claude-cowork-guide/CHANGELOG.md`.
...
- `"Claude Cowork" new features YYYY` (use current year)
- `"claude.ai" Cowork release announcement YYYY`
...
Next steps:
  ...
  git diff machine-readable/claude-cowork-releases.yaml
