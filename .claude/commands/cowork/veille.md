---
name: veille
description: "Product watch — trouve les features Claude desktop non documentées, génère des entrées CHANGELOG"
argument-hint: "[--deep] [--since <YYYY-MM-DD>] [--sources <all|blog|reddit|press>]"
---

# Claude Cowork Product Watch

Cherche sur le web ce qui est nouveau sur la desktop app Claude, compare avec le CHANGELOG local, et identifie les gaps non documentés.
...
Lire `/Users/florianbruniaux/Sites/perso/claude-cowork-guide/CHANGELOG.md`.
...
⚠️ Filtrer les résultats mentionnant "terminal", "CLI", "npm", "claude-code", "Claude Code" — c'est un autre produit.

| # | Query | Cible |
|---|-------|-------|
| 1 | `Anthropic Claude desktop app new features 2026` | Annonces officielles |
| 2 | `claude.ai desktop update changelog site:anthropic.com OR site:docs.anthropic.com` | Blog/docs Anthropic |
| 3 | `Claude desktop app features reddit 2026` | Découvertes communautaires |
| 4 | `"Claude" desktop "new feature" OR "update" OR "plugin" OR "connector" 2026` | Presse tech |
...
- `https://docs.anthropic.com/en/docs/claude-ai/claude-desktop` — docs officielles desktop
